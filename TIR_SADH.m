...
for addition_r=1:imager
    for addition_c=1:imagec
        if (addition_c+2<=imagec)
            addition_mat(addition_r,addition_c)=ir_mat(addition_r,addition_c)+ir_mat(addition_r,addition_c+2);
        else
...
for difference_r=1:imager
    for difference_c=1:imagec
        if (difference_c+2<=imagec)
            difference_mat(difference_r,difference_c)=ir_mat(difference_r,difference_c)-ir_mat(difference_r,difference_c+2);
        else
