...
for k = 1:numfiles
    ...
    initial_query=strcat(VIS_SF_str,TIR_SF_str,VIS_RF_str,TIR_RF_str,VIS_GLDV_str,TIR_GLDV_str,VIS_SADH_str,TIR_SADH_str,PF_str);
    ...
    finalquery=strcat(initial_query,i,file_name,i,d,value_query_VIS_SF,d,value_query_TIR_SF,d,value_query_VIS_RF,d,value_query_TIR_RF,d,value_query_VIS_GLDV,d,value_query_TIR_GLDV,d,value_query_VIS_SADH,d,value_query_TIR_SADH1,d,value_query_PF,c);
    disp(finalquery);
